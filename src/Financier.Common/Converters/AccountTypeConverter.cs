...
namespace Financier.Converters
{
    ...
    public class AccountTypeConverter : IMultiValueConverter
    {
        ...
        private static Uri GetImageUrl(string type, string card_issuer)
        {
            ...
            {
                return new Uri($"pack://application:,,,/Images/ElectronicType/electronic_type_{card_issuer}.png");
            }
            ...
            if (KnownTypes.Contains(type))
            {
                ...
                {
                    return new Uri("pack://application:,,,/Images/AccountType/account_type_card.png");
                }
