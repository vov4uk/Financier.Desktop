...
namespace Financier.Reports.Reports
{
    ...
    {
        // TODO Join ReportStructureCreditVM and ReportStructureDEBITVM only one difference (AND t.from_amount > 0)
...
ORDER  BY total ASC ";
        ...
        protected override void SetupSeries(List<ReportStructureCreditModel> list)
        {
            ...
            var series = list.Select(x => new PieSlice(x.Name, x.Total ?? 0));
